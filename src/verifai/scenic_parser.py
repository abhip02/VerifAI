    ...
    for step in steps:
        if isinstance(step, str):
            ...
            raise NotImplementedError(
                f"'shuffle' is not yet supported by check_with_dfa. "
                f"Operands: {step['shuffle']}"
            )
            ...
            # emit one dict step. If any branch is multi-step, flag it.
            random_step = {}
            multi_step_branches = {}
        ...
        "containers": {
            ...
            "BlackIceRampIncident": {
                ...
                "steps": [
                    ...
                    {"shuffle": {"BlackIceRampAftershockA": 0.6666, "BlackIceRampAftershockB": 0.3333}}
                ]
            },
            "BlackIceRampPrimaryResponse": {
                "kind": "behavior",
                "steps": ["BlackIceRampStabilize", "BlackIceRampFallback", "BlackIceRampTimedRecovery"]
            },
            ...
            "BlackIceRampCleanup": {
                "kind": "behavior",
                "steps": [{"shuffle": {"BlackIceRampExitLeft": 0.5, "BlackIceRampExitRight": 0.5}}]
            },
