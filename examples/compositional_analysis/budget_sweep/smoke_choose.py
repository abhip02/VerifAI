"""Smoke-test the native_choose cell at a small budget.

Mirrors smoke_shuffle.py; verifies do choose parsing + analyzer +
BudgetSweep end-to-end on the max_speed spec.
"""
...
def main() -> None:
    cfg = SweepConfig(
        spec=spec_max_speed(),
        **_kw(
            SCEN_DIR / "metadrive" / "composites/native_choose.scenic",
            "Main",
            "MonoSChooseCXO",
